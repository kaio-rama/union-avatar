...
// export const WebGLContext = createContext<WebGLContextType>({ renderer: null });
...
//   useEffect(() => {
//     // Crear el renderer solo una vez
//     if (!rendererRef.current) {
//       console.log("rendererRef.current papaaaa", rendererRef.current)
...
//       console.log("rendererRef.current mamaaaaaa", rendererRef.current)
//     }
